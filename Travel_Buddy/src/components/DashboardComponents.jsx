  ...
  return (
    <div className="p-3 md:mx-auto">
      <div className="flex flex-wrap gap-4 justify-center ">
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          ...
          <div className="flex gap-2 text-sm">
            <span className="text-green-500 items-center flex ">
              <HiArrowNarrowUp />
              {lastMonthUsers}
            </span>
        ...
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            <div className="">
              <h3 className="text-gray-600 text-md uppercase">
                Total Comments
              </h3>
        ...
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            <div className="">
              <h3 className="text-gray-600 text-md uppercase">Total Posts</h3>
      ...
      <div className="flex flex-wrap justify-center gap-4 py-3 mx-auto">
        <div className="flex flex-col w-full md:w-auto shadow-lg rounded-lg p-2 dark:bg-gray-800">
                  ...
                  <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                    <Table.Cell>
                      <img
                        src={post.image}
                        alt="post"
                        className="h-10 w-14 rounded-md bg-gray-400"
                      />
                    </Table.Cell>
