...
const handleDelete = async(commentId) =>{
  ...
  return (
    <div className="max-w-2xl mx-auto w-full p-3 ">
      {currentUser ? (
        <div className="flex items-center gap-1 my-5 text-gray-500 text-sm">
          ...
          <img
            ...
            alt=""
          />
          <Link to={"/dashboard?tab=profile"} className="text-xs text-teal-500 hover:underline">@{currentUser.username}</Link>
        </div>
      ) : (
        <div className="my-5 text-cyan-400 flex gap-1" >
      ...
      {currentUser && (
        <form onSubmit={handleSubmit} className="border border-purple-500 rounded-md p-4">
            <Textarea 
            ...
            <div className="flex justify-between items-center mt-5">
                ...
                <Button gradientDuoTone="purpleToPink" outline type="submit">Submit</Button>
            </div>
            {commentError &&
